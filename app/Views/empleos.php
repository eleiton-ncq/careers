    ...
    <div class="page">
        ...
        <section class="section section-sm bg-default" id="vacantesdisponibles">
            <div class="container">
                <section class="section section-sm bg-default" id="vacantesdisponibles">
                    <div class="container">
                        <h3 class="oh-desktop"><span class="d-inline-block wow slideInDown">Vacantes disponibles</span>
                        </h3>
                                ...
                                <article class="product-big">
                                    <div class="unit flex-column flex-md-row align-items-md-stretch">
                                        <div class="unit-left"><a class="product-big-figure" href="#"><img
                                                    src="<?php echo base_url().$vacantes_imagenes[$result['position_name']]  ?>"
                                                    alt="" width="600" height="366" /></a></div>
                                        <div class="unit-body">
                                            <div class="product-big-body">
                                                <h5 class="product-big-title"><a
                                                        href="#"><?php echo $result['position_name'] ?></a></h5>
                                                ...
                                                <form method="POST" class="row g-3 needs-validation" novalidate
                                                    ...
                                                    <input type="text" hidden name=""
                                                        value="<?php echo $result['position_name'] ?>">
                                                    <input type="text" hidden name="id"
                                                        value="<?php echo  $result['id'] ?>">
                                                    <button type="submit"
                                                        class="button button-black-outline button-ujarak">Aplicar</button>


                                                </form>
                                                <div class="product-big-price-wrap"><span
                                                        class="product-big-price"><?php echo 'Tiempo completo' // $result['contract_details']  ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
